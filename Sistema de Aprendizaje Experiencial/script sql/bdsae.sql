...
--
-- Host: 127.0.0.1    Database: cognitivo2.0
-- ------------------------------------------------------
...
INSERT INTO `alumno` VALUES ('201323503-4','simon.contreras.13@sansano.usm.cl','Simón','Contreras','qwerty',0,'2016-09-11 15:50:25'),('201373540-1','francisco.garciam.12@sansano.usm.cl','Francisco','García','password',0,'2016-09-11 15:50:58');
...
CREATE TABLE `alumno_has_asignatura` (
  ...
  PRIMARY KEY (`alumno_id_alumno`,`alumno_correo`,`asignatura_id_sigla`),
...
INSERT INTO `alumno_has_asignatura` VALUES ('201323503-4','simon.contreras.13@sansano.usm.cl','FIS-120');
...
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`localhost`*/ /*!50003 TRIGGER plus_inscrito_trigger
AFTER insert ON alumno_has_asignatura
FOR EACH ROW
UPDATE asignatura SET inscritos = inscritos + 1 WHERE id_sigla = new.asignatura_id_sigla */;;
DELIMITER ;
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`localhost`*/ /*!50003 TRIGGER minus_inscrito_trigger
BEFORE DELETE ON alumno_has_asignatura
FOR EACH ROW
UPDATE asignatura SET inscritos = inscritos - 1 WHERE id_sigla = old.asignatura_id_sigla */;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
/*!50003 SET character_set_client  = @saved_cs_client */ ;
/*!50003 SET character_set_results = @saved_cs_results */ ;
...
INSERT INTO `asignatura` VALUES ('FIS-120','Física General 120',2,'2016-09-11 15:30:56','Ramo de Electromagnetismo, circuitos, etc.'),('sigla','nombre nuevo',0,'2016-09-11 10:40:36','descripcion asignatura 1');
...
CREATE TABLE `informacion` (
  ...
  `descripcion` varchar(45) DEFAULT 'Descripción vacía.',
  `clasificacion` int(11) NOT NULL DEFAULT '0',
  `fecha_creacion` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `profesor_id_rut` varchar(15) NOT NULL,
  `profesor_correo` varchar(100) NOT NULL,
...
INSERT INTO `profesor` VALUES ('12345678-9','profesor.fisica@usm.cl','Profesor','Fisica','123456','2016-09-11 15:37:07');
...
INSERT INTO `subunidad` VALUES (6,'Ejercicio 1','Calcule ...','2016-09-11 15:47:50',7);
...
INSERT INTO `unidad` VALUES (7,'Campo magnético','Unidad de campo magnético','2016-09-11 15:40:26','FIS-120','12345678-9','profesor.fisica@usm.cl');
...
--
-- Dumping routines for database 'cognitivo2.0'
--
...
-- Dump completed on 2016-09-11 16:01:05
